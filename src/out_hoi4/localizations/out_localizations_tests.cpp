...
TEST(Outhoi4LocalizationsOutlocalizationsTests, VictoryPointLocalizationsAreOutput)
{
    ...
    ASSERT_TRUE(commonItems::DoesFileExist(
        "output/Outhoi4Localizations/VictoryPointLocalizationsAreOutput/localisation/braz_por/victory_points_l_braz_por.yml"));
    std::ifstream braz_por_file(
        "output/Outhoi4Localizations/VictoryPointLocalizationsAreOutput/localisation/braz_por/victory_points_l_braz_por.yml");
    ASSERT_TRUE(braz_por_file.is_open());
    std::stringstream braz_por_file_stream;
    ...
    ASSERT_TRUE(commonItems::DoesFileExist(
        "output/Outhoi4Localizations/VictoryPointLocalizationsAreOutput/localisation/english/victory_points_l_english.yml"));
    std::ifstream english_file(
        "output/Outhoi4Localizations/VictoryPointLocalizationsAreOutput/localisation/english/victory_points_l_english.yml");
    ASSERT_TRUE(english_file.is_open());
    std::stringstream english_file_stream;
    ...
    ASSERT_TRUE(commonItems::DoesFileExist(
        "output/Outhoi4Localizations/VictoryPointLocalizationsAreOutput/localisation/french/victory_points_l_french.yml"));
    std::ifstream french_file(
        "output/Outhoi4Localizations/VictoryPointLocalizationsAreOutput/localisation/french/victory_points_l_french.yml");
    ASSERT_TRUE(french_file.is_open());
    std::stringstream french_file_stream;
    ...
    ASSERT_TRUE(commonItems::DoesFileExist(
        "output/Outhoi4Localizations/VictoryPointLocalizationsAreOutput/localisation/german/victory_points_l_german.yml"));
    std::ifstream german_file(
        "output/Outhoi4Localizations/VictoryPointLocalizationsAreOutput/localisation/german/victory_points_l_german.yml");
    ASSERT_TRUE(german_file.is_open());
    std::stringstream german_file_stream;
    ...
    ASSERT_TRUE(commonItems::DoesFileExist(
        "output/Outhoi4Localizations/VictoryPointLocalizationsAreOutput/localisation/japanese/victory_points_l_japanese.yml"));
    std::ifstream japanese_file(
        "output/Outhoi4Localizations/VictoryPointLocalizationsAreOutput/localisation/japanese/victory_points_l_japanese.yml");
    ASSERT_TRUE(japanese_file.is_open());
    std::stringstream japanese_file_stream;
    ...
    ASSERT_TRUE(commonItems::DoesFileExist(
        "output/Outhoi4Localizations/VictoryPointLocalizationsAreOutput/localisation/polish/victory_points_l_polish.yml"));
    std::ifstream polish_file(
        "output/Outhoi4Localizations/VictoryPointLocalizationsAreOutput/localisation/polish/victory_points_l_polish.yml");
    ASSERT_TRUE(polish_file.is_open());
    std::stringstream polish_file_stream;
    ...
    ASSERT_TRUE(commonItems::DoesFileExist(
        "output/Outhoi4Localizations/VictoryPointLocalizationsAreOutput/localisation/russian/victory_points_l_russian.yml"));
    std::ifstream russian_file(
        "output/Outhoi4Localizations/VictoryPointLocalizationsAreOutput/localisation/russian/victory_points_l_russian.yml");
    ASSERT_TRUE(russian_file.is_open());
    std::stringstream russian_file_stream;
    ...
    ASSERT_TRUE(commonItems::DoesFileExist(
        "output/Outhoi4Localizations/VictoryPointLocalizationsAreOutput/localisation/spanish/victory_points_l_spanish.yml"));
    std::ifstream spanish_file(
        "output/Outhoi4Localizations/VictoryPointLocalizationsAreOutput/localisation/spanish/victory_points_l_spanish.yml");
    ASSERT_TRUE(spanish_file.is_open());
    std::stringstream spanish_file_stream;
