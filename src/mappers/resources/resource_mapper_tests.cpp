...
TEST(MappersResourcesResourceMapperTests, EmptyMapperNoScore)
{
...
{
   std::map<std::string, ResourceScore> empty{
     {"steel", {{{"building_iron_mine", 1.0F}}, {}, 0.0F}},
   };
   ResourceMapper mapper(empty);
...
{
   std::map<std::string, ResourceScore> empty{
     {"steel", {{{"building_iron_mine", 1.0F}}, {"building_coal_mine"}, 0.1F}},
     {"oil", {{{"building_oil_rig", 1.0F}}, {"building_coal_mine"}, 0.1F}},
   };
   ResourceMapper mapper(empty);
