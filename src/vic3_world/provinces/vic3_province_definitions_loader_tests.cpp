...
{
   const commonItems::ModFilesystem mod_filesystem("test_files/vic3_world/provinces/game", {});
...
{
   const commonItems::ModFilesystem mod_filesystem("test_files/vic3_world/missing_provinces/game", {});
