    ...
    const commonItems::ModFilesystem& mod_filesystem)
{
   ...
   // culture_definition_parser.registerKeyword("ethnicities", [&ethnicities](std::istream& input_stream) {
   //    std::vector<std::string> cultural_ethnicities = commonItems::getStrings(input_stream);
   //    std::ranges::copy(cultural_ethnicities, std::inserter(ethnicities));
   // });
   ...
   //    std::ranges::copy(male_names, std::inserter(name_list.male_common_first));
   // });
   ...
   //    std::ranges::copy(female_names, std::inserter(name_list.female_common_first));
   // });
   ...
   //    std::ranges::copy(last_names, std::inserter(name_list.common_last));
   // });
   ...
   //    std::ranges::copy(noble_last_names, std::inserter(name_list.noble_last));
   // });
   ...
   //    std::ranges::copy(male_noble_names, std::inserter(name_list.male_regal_first));
   // });
   ...
   //    std::ranges::copy(female_noble_names, std::inserter(name_list.female_regal_first));
   // });
