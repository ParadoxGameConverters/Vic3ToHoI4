...
TEST(Vic3worldStatesStateRegionsImporterTests, SignificantProvincesAreImported)
{
   const commonItems::ModFilesystem mod_filesystem("test_files/vic3_world/states/SignificantProvincesAreImported", {});
   const std::map<std::string, StateRegion> state_regions = ImportStateRegions(mod_filesystem);
