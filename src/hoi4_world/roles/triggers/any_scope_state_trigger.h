...
class AnyScopeStateTrigger: public Trigger
{
  public:
   explicit AnyScopeStateTrigger(std::vector<std::unique_ptr<Trigger>> children): children_(std::move(children)) {}
   AnyScopeStateTrigger(const AnyScopeStateTrigger&) = default;
   AnyScopeStateTrigger& operator=(const AnyScopeStateTrigger&) = default;
   AnyScopeStateTrigger(AnyScopeStateTrigger&&) = default;
   AnyScopeStateTrigger& operator=(AnyScopeStateTrigger&&) = default;
   ~AnyScopeStateTrigger() override = default;

   [[nodiscard]] bool operator==(const Trigger& rhs) const override { return PolymorphicEquality(*this, rhs); }
   [[nodiscard]] bool operator==(const AnyScopeStateTrigger& rhs) const;
   ...
   friend void PrintTo(const AnyScopeStateTrigger& trigger, std::ostream* os);
