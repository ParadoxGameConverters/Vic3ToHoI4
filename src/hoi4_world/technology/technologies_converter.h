#ifndef SRC_HOI4WORLD_TECHNOLOGY_TECHNOLOGIESCONVERTER_H
#define SRC_HOI4WORLD_TECHNOLOGY_TECHNOLOGIESCONVERTER_H
...
#endif  // SRC_HOI4WORLD_TECHNOLOGY_TECHNOLOGIESCONVERTER_H