...
TEST(Hoi4worldFocustreesFocusimporterTests, DefaultsAreDefaulted)
{
   ...
   EXPECT_FALSE(focus.tree_starter);
   ...
   EXPECT_FALSE(focus.will_lead_to_war_with.has_value());
...
TEST(Hoi4worldFocustreesFocusimporterTests, ItemsCanBeImported)
{
   ...
   input << "\tmutually_exclusive = { focus = test_mutually_exclusive }\n";
   input << "\tbypass = { test_bypass }\n";
   input << "\ttree_starter = yes\n";
   input << "\tx = 3\n";
   input << "\ty = 5\n";
   ...
   input << "\twill_lead_to_war_with = test_will_lead_to_war_with\n";
   ...
   EXPECT_EQ(focus.will_lead_to_war_with.value_or(""), "test_will_lead_to_war_with");
