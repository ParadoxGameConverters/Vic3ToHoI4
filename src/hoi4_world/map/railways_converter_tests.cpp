...
{
   std::map<std::string, vic3::StateRegion> vic3_state_regions;
   for (int i = 1; i < 102; ++i)
   {
      vic3_state_regions.emplace(fmt::format("STATE_{}", i),
          vic3::StateRegion(std::map<std::string, std::string>{{fmt::format("x000{:0>3}", i), "city"}}, {}));
   }
