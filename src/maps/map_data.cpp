...
void maps::MapData::AddNeighbor(const std::string& main_province, const std::string& neighbor_province)
{
...
void maps::MapData::RemoveNeighbor(const std::string& main_province, const std::string& neighbor_province)
{
   if (const auto center_mapping = province_neighbors_.find(main_province); center_mapping != province_neighbors_.end())
   {
...
void maps::MapData::AddPointToBorder(const std::string& main_province,
